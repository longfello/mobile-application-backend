        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'Founds'),
                        'icon' => '<i class="fa fa-chevron-right"></i>',
                        'url' => ['/founds/index'],
                        'visible' => Yii::$app->user->can('administrator')
                    ],
                    [
                        'label' => Yii::t('backend', 'Sound'),
                        'icon' => '<i class="fa fa-music"></i>',
                        'url' => ['/sound/index'],
                        'visible' => Yii::$app->user->can('administrator')
                    ],
                    [
                        'label' => Yii::t('backend', 'Habit'),
                        'icon' => '<i class="fa fa-chevron-right"></i>',
                        'url' => ['/habit/index'],
                        'visible' => Yii::$app->user->can('administrator')
                    ],
                    ...
                    [
                        'label' => Yii::t('backend', 'Invites'),
                        'icon' => '<i class="fa fa-chevron-right"></i>',
                        'url' => ['/invites/index'],
                        'visible' => Yii::$app->user->can('administrator')
                    ],
//                    [
//                        'label' => Yii::t('backend', 'TaskStatus'),
//                        'icon' => '<i class="fa fa-music"></i>',
//                        'url' => ['/task-status/index'],
//                        'visible' => Yii::$app->user->can('administrator')
//                    ],
                    [
                        'label' => Yii::t('backend', 'TaskType'),
                        'icon' => '<i class="fa fa-chevron-right"></i>',
                        'url' => ['/task-type/index'],
                        'visible' => Yii::$app->user->can('administrator')
                    ],
