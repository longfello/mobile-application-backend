...
//            [['username'], 'filter', 'filter' => '\yii\helpers\Html::encode']
    ...
    {
        return $this->hasMany(Invites::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Task::className(), ['id' => 'task_id'])->viaTable('invites', ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(TaskDonation::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(TaskStatus::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Task::className(), ['id' => 'task_id'])->viaTable('task_status', ['user_id' => 'id']);
    }
