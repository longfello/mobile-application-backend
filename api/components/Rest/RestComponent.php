...
use api\components\Rest\Post\UserLogin;
...
class RestComponent extends Component
{
    ...
    public function authenticate(){
        ...
        Yii::$app->response->headers->add("WWW-Authenticate", "Basic realm=\"Restricted Zone\"");
        Yii::$app->response->throwError(ErrorCode::BASIC_AUTH);
    }
}